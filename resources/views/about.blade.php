    ...
    <div class="columns is-centered">
        <div class="column is-full-mobile is-three-fifths-tablet is-three-fifths-desktop is-half-widescreen">
            ...
            <p class="has-text-justified about-montserrat-p-text">
                ...
                overly passionate about Jeeps, JeepMeet can still help you connect with fellow Jeepers. We are constantly looking 
            ...
            <p class="has-text-justified about-montserrat-p-text">
                ...
                There are plans to build a mobile application in the future for both <span class="icon is-small"><i class="fab fa-android"></i></span> 
                and <span class="icon is-small"><i class="fab fa-apple"></i></span>. We started with a web application to reach as many people as possible early on, but
                keep an eye out for the mobile applications.
            </p>
        </div>
    </div>
</section>
