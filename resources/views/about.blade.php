  ...
  <div class="columns is-centered">
    <div class="column is-full-mobile is-three-fifths-tablet is-three-fifths-desktop 
      ...
      <p class="has-text-justified about-montserrat-p-text">
        ...
        class="about-laravel-text has-text-weight-semibold" target="_blank">Laravel</a> Framework.
        The site is hosted via <a href="https://www.digitalocean.com/" 
        class="about-digitalocean-text has-text-weight-semibold" target="_blank">Digital Ocean</a>.
        All of our source code can be viewed on <a href="https://github.com/jlug331221/JeepMeet" 
        class="about-github-text has-text-weight-semibold" target="_blank">GitHub</a>.
        There are plans to build a mobile application in the future for both 
        <span class="icon is-small"> <i class="fab fa-android"></i></span> and 
        <span class="icon is-small"> <i class="fab fa-apple"></i></span>. We started with a web 
        application to reach as many people as possible early on, but keep an eye out for the 
