                    ...
                    <div class="container">
                        ...
                        <em><small>
                            <p class="welcome-montserrat welcome-small-subtitle-text">
                                No matter the time or place, JeepMeet is here to help you find people that are just as enthusiastic and passionate about Jeeps.
                            </p>
                        </small></em>
                    </div>
                </div>
    ...
    <div class="columns is-centered">
        <div class="column has-text-centered is-full-mobile is-one-half-tablet is-one-half-desktop">
            <h3 class="is-size-6-mobile is-size-5-tablet is-size-4-desktop">
                Engage with members of the community on our <a href="#"><span class="welcome-forum-text has-text-weight-bold">Forum</span></a>.
            </h3>
        ...
        <div class="column has-text-centered welcome-column-margin-top is-full-mobile is-one-half-tablet is-one-half-desktop">
            @guest
                <h3 class="is-size-6-mobile is-size-5-tablet is-size-4-desktop">Join today and post your first JeepMeet.</h3>

                <a class="button button-filled is-rounded signup-button welcome-signup-button" href="{{ url('/join') }}"><strong>Join</strong></a>
            @endguest

            @auth
                <h3 class="is-size-6-mobile is-size-5-tablet is-size-4-desktop">Go to your profile and build up that JeepMeet Cred!</h3>

                <a class="button button-empty is-rounded signup-button welcome-profile-button" href="{{ url('/profile') }}"><strong>Profile</strong></a>
            @endauth
        </div>
    </div>
</section>
