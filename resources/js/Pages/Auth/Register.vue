  ...
  setup(props) {
    ...
    function submitButtonDisabled() {
      return (
        ...
        (formFields.location_country === 'United States of America' &&
      ...
      formFields.post('/register', {
        ...
        onError: () => {
          ...
          if (formFields.hasErrors) {
            ...
            if (formFields.errors.username) {
              formFields.username = '';
            }

            if (formFields.errors.email) {
              formFields.email = '';
            }

            if (formFields.errors.password) {
              formFields.password = '';
              formFields.password_confirmation = '';
            }

            if (formFields.errors.location_country) {
              formFields.location_country = '';
              formFields.location_state_province = '';
            }
          }
