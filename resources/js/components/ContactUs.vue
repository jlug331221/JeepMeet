              ...
              <div class="field required">
                ...
                <div class="control">
                  <input v-model="$v.formFields.first_name.$model"
                    class="input" type="text" placeholder="Lewis" name="first_name">
              ...
              <div class="field">
                ...
                <div class="control">
                  <input v-model="formFields.last_name" class="input" type="text"
                    placeholder="Hamilton" name="last_name">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="field required">
            ...
            <div class="control has-icons-left has-icons-right">
              <input v-model="formFields.email"
                ...
                type="email" placeholder="lewis.hamilton@mail.com" name="email">
              ...
              <span v-if="$v.formFields.email.$invalid" 
